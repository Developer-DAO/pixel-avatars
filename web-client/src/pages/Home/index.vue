...
import {default as LaunchBanner, useLaunchCounter} from "../../components/LaunchBanner";

const networkConfigured = PIXEL_AVATAR_NETWORK.chainId > 0
const previewState = usePreviewState()
const launchCounter = useLaunchCounter()
const showConnectButton = computed(() => networkConfigured && launchCounter.launched.value)
...
<template>
    ...
    >
        ...
        "
        >
            <div class="sm:w-2/5 bg-white dark:bg-gray-900 py-6 sm:py-10 px-4 flex">
                <div
                    class="
                    flex flex-col
                    items-center
                ...
                >
                    <div
                        ...
                        :class="
                            showConnectButton ? 'justify-between' : 'justify-around'
                        "
                    >
                ...
                <div class="flex flex-col sm:h-full sm:sticky sm:top-0">
                    ...
                    >
                        <a
                            ...
                            class="flex items-center space-x-3 dark:text-gray-300"
                        >
