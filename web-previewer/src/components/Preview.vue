...
<template>
    <div>
        ...
        <div class="flex justify-end mb-10">
            ...
            <a target="_blank" title="Github" href="https://github.com/Developer-DAO/pixel-avatars" class="m-1 text-sm">View on Github</a>
            <a target="_blank" title="Github" href="https://github.com/Developer-DAO/pixel-avatars" >
